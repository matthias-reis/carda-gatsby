...
<RemoteImage alt={`Denise auf dem Überlebenshof Scottmaring`} size="medium"
...
Die kreative Friedbergerin häkelt nicht nur, sie hat noch viele weitere
Talente. Seit frühester Kindheit malt und zeichnet sie, meistens schwarz-weiß
mit Kohle, Bleistift oder Kreide. Später kam dann noch die Bildhauerei dazu.

## Farbe, Licht und Freiheit

Während ihrer Ausbildung zur Kunsttherapeutin entdeckte Denise die Farben für
sich, lernte sie kennen und lieben und bringt sie seitdem in ihren
Kunstwerken zum Einsatz.
...
<RemoteImage alt={`Denise beim Zaunbau auf dem Überlebenshof`} size="medium"
...
<RemoteImage alt={`Bild aus dem Atelier von Denise`} size="medium"
...
<RemoteImage alt={`Sissi und Franz`} size="medium" title={`Sissi und Franz`}
...
Während mir Denise von ihren Kunstwerken erzählte, berichtete sie mir auch
von Sissi und Franz. Sissi wurde von einer Tierärztin entdeckt, die ihn auf
einen Überlebenshof [<sup>3</sup>](#3) brachte. Dort kümmert man sich seither um
ihre Versorgung.
...
<RemoteImage alt={`Franz`} size="medium" title={`Franz`}

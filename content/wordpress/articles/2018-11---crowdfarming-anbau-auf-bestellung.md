...
<RemoteImage alt={`crowdfarming`} size="full" title={``}
...
<RemoteImage alt={``} size="medium" title={`Gabriel und Gonzalo Urculo`}
...
<RemoteImage alt={`crowdfarming`} size="medium" title={`Aprikosen`}
...
<RemoteImage alt={`crowdfarming`} size="medium" title={`Oliven`}

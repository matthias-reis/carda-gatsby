...
<RemoteImage alt={`Veganica Biomanufaktur`} size="medium" title={``}
...
<RemoteImage alt={`Veganica Biomanufaktur`} size="full"
...
<RemoteImage alt={`Veganica Bio Manufaktur`} size="full" title={``}

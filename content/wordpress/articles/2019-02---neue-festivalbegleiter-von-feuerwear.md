...
<RemoteImage alt={`Feuerwear`} size="medium" title={`Geldbörse in Hip Bag`}
...
<RemoteImage alt={`Feuerwear`} size="medium" title={`Da geht einiges rein!`}
...
<RemoteImage alt={`Feuerwear`} size="medium" title={`Meine Feuerwear Börse`}

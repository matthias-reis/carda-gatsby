...
<RemoteImage alt={`Klimaschutz`} size="medium" title={`Bekassine im Köngismoor`}
...
<RemoteImage alt={`Klimaschutz`} size="medium" title={`Wollgras`}
...
<RemoteImage alt={`Klimaschutz`} size="medium" title={`Der Moorpegel`}
...
<RemoteImage alt={`Klimaschutz`} size="medium" title={`Winter im Königsmoor`}

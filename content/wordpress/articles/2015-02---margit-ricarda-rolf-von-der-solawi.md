...
<RemoteImage
  ...
  size="medium"
  title={` Zurzeit arbeiten 12 Personen am Projekt SoLaWi Hamburg`}
...
<RemoteImage
  ...
  size="medium"
  title={` Obst aus ökologischem Landbau`}
...
<RemoteImage
  ...
  size="medium"
  title={` Nach der Sommerpause soll es losgehen`}
...
<RemoteImage
  ...
  size="medium"
  title={` Ricarda ist ganz frisch auf vegan umgestiegen`}
...
<RemoteImage
  ...
  size="medium"
  title={` Vegane Produkte sollten gekennzeichnet werden`}
...
**Ricarda:** Da geht noch mehr. Noch viel mehr! Ärgerlich ist es, wenn **vegane Produkte** nicht [gekennzeichnet](/2014/12/05/versteckte-tierische-inhaltsstoffe-in-lebensmitteln/) werden, man im Supermarkt vegane Margarine zwischen Milchprodukten findet, Hafersahne zwischen H-Milch und H-Sahne und Kichererbsen gar nicht. Wie gesund vegane Nahrung ist, hat sich noch nicht herumgesprochen. Da gibt es noch sehr viel zu tun und in den Schulen müssen wir anfangen.
...
<RemoteImage
  ...
  size="medium"
  title={` Selbst entscheiden, was auf den Teller kommt`}
...
**Ricarda:** Wir wollen auf Imker verzichten. Daher habe ich Kontakt zu Markus Gastl. Sein [3-Zonen-Garten-Modell](http://www.hortus-insectorum.de) ist eine schöne Anregung.

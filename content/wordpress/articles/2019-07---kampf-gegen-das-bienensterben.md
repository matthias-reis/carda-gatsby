...
<RemoteImage alt={`Arbeiterbienen`} size="medium" title={`Arbeiterbienen`}
...
Dabei lautet das Ergebnis einer europaweiten Metastudie, dass der Einsatz von
...
<RemoteImage alt={`bienen`} size="medium"

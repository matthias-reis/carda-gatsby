...
description: Bienen sterben, weil wir ihren natürlich Lebensraum zerstören und sie
  ausbeuten, auch indem wir ihnen ihren Honig wegnehmen.
excerpt: Bienen sterben, weil wir ihren natürlich Lebensraum zerstören und sie ausbeuten,
  auch indem wir ihnen ihren Honig wegnehmen.
fileName: 2014-10---honig-das-ist-jetzt-aber-wirklich-uebertrieben-oder.md
remoteThumbnailImage: https://storage.googleapis.com/cardamonchai-images/2014_10_14357441908_09b3d46f87_z__m.jpg
remoteImage: https://storage.googleapis.com/cardamonchai-images/2014_10_14357441908_09b3d46f87_z__l.jpg
...
> zerstören, dann wird er beständig zunehmen." - Buddha

### Was ist eigentlich Honig?

<RemoteImage alt={`Arbeiterbiene in Aktion`} size="medium"
...
<RemoteImage alt={`Bienen saugen den Nektar über den Rüssel auf`} size="medium"
...
aufnehmen, enthalten. [<sup>4</sup>](#4)
...
<RemoteImage alt={`Arbeiterbienen`} size="medium"
...
beschäftigt sind, können sie sich nicht durch Stechen  verteidigen, der Imker
...
<RemoteImage alt={`Biene im Flug`} size="thumbnail"
...
Bei Variante drei setzt der Imker eine befruchtete Königin in den Bienenstock,
...
<RemoteImage alt={`Bienen beim Verlassen des Bienenstocks`} size="medium"
...
<RemoteImage alt={`Fleißige Sammlerin`} size="medium"
...
<RemoteImage alt={`Für Euch getestet: Tolle Alternativen`} size="medium"
...
<RemoteImage alt={`Sie fliegt von Blüte zu Blüte`} size="full"

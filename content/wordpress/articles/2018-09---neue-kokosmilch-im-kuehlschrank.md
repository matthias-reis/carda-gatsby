...
"Coco Milk For Drinking" , die es bereits in den Bioläden gibt, wird von der
neuen klassischen Sorte abgelöst. Diese hat mit 63 Prozent einen deutlich
höheren Kokosanteil, als die Vorgängervariante. Diese hatte lediglich 33
Prozent.

## Vegan, bio und ohne Gentechnik

<RemoteImage alt={`Kokosmilch`} size="medium" title={``}
...
<RemoteImage alt={`Kokosmilch`} size="medium" title={`Mein Kokos-Cappuccino`}
...
Übrigens habe ich im Sortiment von Dr. Martins auch Kokosmilch zum Kochen
entdeckt.

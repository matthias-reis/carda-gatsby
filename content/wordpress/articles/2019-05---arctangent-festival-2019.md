...
innerhalb der [UK](/category/slow-travel/britische-inseln/) verliehen und auch
auf der Shortlist für den Award für das beste Line-up ist es aufgeführt.
...
<RemoteImage alt={`arctangent-timetable-donnerstag`} size="full"
...
<RemoteImage alt={`arctangent-timetable-freitag`} size="full"
...
<RemoteImage alt={`arctangent-timetable-samstag`} size="full"

...
<RemoteImage alt={`Boysetsfire live im Docks`} size="medium"
...
wie "Release The Dogs", "Empire" und "My Life In The Knife Trade". Auf
der Facebook-Seite der Band schreibt Nate heute "Es werden keine Shows abgesagt
...
<RemoteImage alt={`Mein Tweet auf dem Profil von Boysetsfire`} size="large"

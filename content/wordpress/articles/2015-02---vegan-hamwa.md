...
<RemoteImage
  alt={`Vegan`}
  size="medium"
  title={` Garantiert ohne Rind: Selbstgemachte Seitanburger`}
...
<RemoteImage
  alt={`Vegan`}
  size="medium"
  title={` Hier gibt es jetzt auch vegane Gerichte`}
...
<RemoteImage
  alt={`Vegan`}
  size="medium"
  title={` Bietet nicht nur Avocados: Die vegane Küche`}

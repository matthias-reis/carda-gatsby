...
<RemoteImage alt={`Cap San Diego`} size="medium"
...
<RemoteImage alt={`Cap San Diego`} size="medium" title={`So groß!`}
...
<RemoteImage alt={`Cap San Diego`} size="medium" title={`Schraube`}

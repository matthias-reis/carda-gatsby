...
<RemoteImage alt={`Ganz schön groß diese Zucchini`} size="medium"
...
<RemoteImage alt={`Alles schön anbraten`} size="medium"
...
<RemoteImage alt={`Der Kater staunt - Die Zucchini ist größer als er!`}
size="medium" title={`Der Kater staunt - Die Zucchini ist größer als er!`}
